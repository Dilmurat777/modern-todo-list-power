    ...
    <div className={`group p-4 hover:bg-gray-100 transition-all duration-200`}>
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          <div className={`text-gray-800 loading-relaxed`}></div>
        ...
        <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-all duration-200">
          ...
          <button className="p-2 text-gray-500 hover:text-gray-800 hover:bg-red-200 rounded-lg transition-all duration-200">
            <Trash2 size={16} />
          </button>
        </div>
      </div>
